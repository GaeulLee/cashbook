	...
	<div class="container">
		<form action="<%=request.getContextPath()%>/admin/comment/insertCommentAction.jsp" method="post">
			...
			<table class="table table-borderless w-75 mx-auto align-middle shadow-sm mt-3">
				<tr>
					<th colspan="2">
						<h4 class="mt-3"><strong>답변 하기</strong></h4>
					</th>
				</tr>
				<%
				...
				<tr>
					<th>답변 내용</th>
					<td>
						<textarea name="commentMemo" rows="10" cols="50" placeholder="입력할 답변을 입력해주세요." class="form-control"></textarea>
					</td>
				</tr>
				<tr>
					<td colspan="2">
						<button type="submit" class="btn btn-outline-primary float-end">답변</button>
					</td>
				</tr>
			</table>
		</form>
